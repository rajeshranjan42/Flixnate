...
<head>
    ...
    <title>Contact Us - Flixnate</title>
            ...
            <div class="contact-form-container">
                ...
                <form method="POST" action="contact.php" class="contact-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" required rows="5"><?php echo isset($message) ? htmlspecialchars($message) : ''; ?></textarea>
                    </div>
